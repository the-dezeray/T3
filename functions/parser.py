...
class InputObject:
    def __init__(self):
        ...
        self.string =""
    def set_type_task(self): self.type = Types.TASK ;print("set type to task")
    def set_operation_add(self):self.operation = Operation.ADD  
    def set_type_reminder(self): self.type = Types.REMINDER
    def set_type_journal(self): self.type = Types.JOURNAL
    def set_operation_remove(self):self.operation = Operation.REMOVE
    def set_type_functional(self): self.type = Types.FUNCTIONAL
